...
const timelineEvents = [
  ...
  {
    year: "1950ம ஆண்டு – பாரம்பரியம் & புது யுகம்",
  ...
  {
    year: "இன்று வரை -தென்னிந்தியாவின் மூலிகை பாரம்பரியம்",
    ...
    <main className="bg-white">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto space-y-6">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-2xl md:text-4xl font-bold text-[#C22220] text-center leading-relaxed"
        >
          இயற்கை வழியில் நோயின் பிணியைப் போக்கி, ஆரோக்கியமான வாழ்விற்கு - <span className="text-gray-700 font-semibold text-sm md:text-xl">RJR ஹெர்பல் மருத்துவமனை.</span>
        </motion.h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-[#C22220] text-white rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row items-stretch"
        >
          <div className="p-8 md:p-12 md:w-2/3 space-y-6 flex flex-col justify-center">
            <h3 className="text-2xl md:text-3xl font-bold text-yellow-400">
              எங்கள் நிறுவனர் <br /> <span className="text-white text-xl md:text-2xl">டாக்டர் எஸ்.ஆர். ஜெயதுரை<span className="text-yellow-400 text-xs md:text-sm"> B.Sc, BNYS, DVM, PGDYN  </span></span>
            </h3>
            ...
            <p className="text-white/90 leading-relaxed text-lg hidden md:block">
              இயற்கை மருத்துவத்தின் மீதான ஆர்வத்தை அவருக்குள் விதைத்தவர், கிராமத்து வைத்தியராகத் திகழ்ந்த அவரது அம்மா வழி தாத்தாவாகிய பொன்னையா பயில்வான் மற்றும் தாய் மாமன்மார்கள் ஆவர். சிறுவயது முதலே, மூலிகைகளைக் கொண்டு மருந்துகள் தயாரிப்பதற்கு உதவியாகவும், நோயாளிகளுக்குச் சிகிச்சை அளிப்பதையும் ஜெயதுரை அவர்கள் அருகில் இருந்து கவனித்து வந்தார்.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center space-y-8">
          <motion.h2
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-3xl md:text-4xl font-bold text-[#C22220]"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 bg-gray-50 shadow-sm border border-gray-100 rounded-2xl hover:bg-white hover:shadow-lg transition-all duration-300"
              >
